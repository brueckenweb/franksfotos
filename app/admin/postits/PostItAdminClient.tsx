...
/** HTML-Tags entfernen – für Tabellenvorschau */
function stripHtml(html: string): string {
  return html.replace(/<[^>]*>/g, " ").replace(/\s+/g, " ").trim();
}

/** Prüft ob TipTap-Inhalt leer ist */
...
const EMPTY_FORM: FormState = { message: "", color: "yellow", slot: "" };
      ...
      {editId && editNote && (
        <div className="mb-6">
          <PostItForm
            ...
            initial={{ message: editNote.message, color: editNote.color, slot: editNote.slot }}
            onSave={handleEdit}
                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`text-xs px-2 py-0.5 rounded-full font-medium ${COLOR_BG[note.color] ?? ""} text-gray-800`}
                        >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 max-w-sm w-full mx-4 shadow-2xl">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Das Post-It wird unwiderruflich gelöscht.
            </p>
