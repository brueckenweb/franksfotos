module.exports = {
  apps: [{
    ...
    script: 'npm',
    args: 'start',
    cwd: '/www/frank-sellke',
    instances: 1,
    exec_mode: 'fork',
    error_file: '/www/frank-sellke/log/pm2/franksfotos-error.log',
    out_file: '/www/frank-sellke/log/pm2/franksfotos-out.log',
    log_file: '/www/frank-sellke/log/pm2/franksfotos-combined.log',
    time: true,
